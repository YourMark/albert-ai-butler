...
= 1.4.2 =
Fixes some AI assistants (including Claude Code) refusing to connect over a missing piece of sign-in information. Recommended if an assistant will not connect.
