...
class Delete extends BaseAbility {
	...
	public function __construct() {
		...
		$this->label       = __( 'Delete Page', '' );
		$this->description = __( 'Delete a WordPress page permanently or move it to trash.', '' );
	...
	public function check_permission(): bool {
		...
		// Get the route pattern for deleting a specific page.
	 ...
	 * }
	 * @return array|WP_Error Deletion result on success, WP_Error on failure.
	 * @since 1.0.0
	 */
	public function execute( array $args ): array|WP_Error {
		...
		if ( $response->is_error() ) {
			return new WP_Error(
				...
				$data['message'] ?? __( 'An error occurred while deleting the page.', '' ),
