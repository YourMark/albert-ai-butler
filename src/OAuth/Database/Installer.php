...
class Installer {
	 ...
	 * @var string
	 */
	const DB_VERSION_OPTION = 'aibridge_oauth_db_version';
	...
	private static function get_clients_table_sql( string $charset_collate ): string {
		...
		$table_name = $wpdb->prefix . 'aibridge_oauth_clients';
	...
	private static function get_refresh_tokens_table_sql( string $charset_collate ): string {
		...
		$table_name = $wpdb->prefix . 'aibridge_oauth_refresh_tokens';
	...
	private static function get_auth_codes_table_sql( string $charset_collate ): string {
		...
		$table_name = $wpdb->prefix . 'aibridge_oauth_auth_codes';
	...
	public static function get_table_names(): array {
		...
		return [
			'clients'        => $wpdb->prefix . 'aibridge_oauth_clients',
			'access_tokens'  => $wpdb->prefix . 'aibridge_oauth_access_tokens',
			'refresh_tokens' => $wpdb->prefix . 'aibridge_oauth_refresh_tokens',
			'auth_codes'     => $wpdb->prefix . 'aibridge_oauth_auth_codes',
		];
	}
